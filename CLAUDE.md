...
Internal operational system for kng-bizsystem team to log, track, and view recurring workflow records replacing spreadsheets and chat.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "3244823+KarenNg@users.noreply.github.com"
  git config user.name "KarenNg"
  ```
